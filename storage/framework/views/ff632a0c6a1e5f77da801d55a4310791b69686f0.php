...
<head>
    ...
    <title>GESTION DE CERTIFICATS</title>
    <!-- Favicon-->
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span style="text-transform: uppercase;"><?php echo e(Auth::user()->name); ?> </span></div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="<?php echo e(route('gestion_certif')); ?>">
        ...
        <div class="container-fluid">
          ...
          <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>ENREGISTREMENT D'UNE NOUVELLE LICENCE SPORTIVE</h2>
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST" enctype="multipart/form-data" action="<?php echo e(route('certif.store')); ?>">
                                 <?php echo e(csrf_field()); ?>
                                ...
                                <div class="form-group form-float" class="form-group<?php echo e($errors->has('prenom') ? ' has-error' : ''); ?>">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="prenom" value="<?php echo e(old('prenom')); ?>" required>
                                ...
                                <div class="form-group form-float" class="form-group<?php echo e($errors->has('categorie') ? ' has-error' : ''); ?>">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="categorie"  value="<?php echo e(old('categorie')); ?>" required>
                                ...
                                <div class="form-group form-float" class="form-group<?php echo e($errors->has('club') ? ' has-error' : ''); ?>">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="club"  value="<?php echo e(old('club')); ?>" required>
                                 ...
                                 <div class="form-group form-float" class="form-group<?php echo e($errors->has('assurance') ? ' has-error' : ''); ?>">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="assurance"  value="<?php echo e(old('assurance')); ?>" required>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control show-tick" name="sang">
                                        <option value="">-- Veuillez choisir le groupe sanguin --</option>
                                ...
                                <div class="row clearfix">
                                <div class="col-sm-6">
                                 <select class="form-control show-tick" name="medical" required>
                                        <option value="">La visite médicale est elle à jour?</option>
                                 ...
                                 <div class="form-group form-float" class="form-group<?php echo e($errors->has('tel') ? ' has-error' : ''); ?>">
                                    <div class="form-line">
                                        <input type="tel" class="form-control" name="tel"  value="<?php echo e(old('tel')); ?>" required>
                                   ...
                                   <div class="form-group form-float" class="form-group<?php echo e($errors->has('licence') ? ' has-error' : ''); ?>">
                                    <div class="form-line">
                                        ...
                                        <input type="text" class="form-control" name="licence"  value="<?php echo e(old('licence')); ?>" required>
                                     ...
                                     <label> Veuillez choisir la  Photo  </label>
                                     <div class="form-group form-float" class="form-group<?php echo e($errors->has('photo') ? ' has-error' : ''); ?>">
                                    <div class="form-line">
                            ...
                            <div class="demo-masked-input">
                                        ...
                                        <div class="input-group"style="display:inline-block;text-align: center;">
                                         ...
                                         Date de validité
                                            ...
                                            <span class="input-group-addon">
                                                ...
                                                <input type="text" class="form-control date" name="date_valide" placeholder="Ex: 30/07/2016">
                                            </div>
                                ...
                                <button class="btn btn-primary waves-effect" type="submit">Soumettre</button>
                            </form>
                        </div>
                    </div>
                </div>
