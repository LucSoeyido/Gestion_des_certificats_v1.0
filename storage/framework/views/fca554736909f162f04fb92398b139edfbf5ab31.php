  ...
  <div class="row">
    ...
    <div class="card horizontal">
      <div class="card-image">
        ...
        <img src="uploads\<?php echo e(Session::get('number')->photo); ?>">
      </div>
      <div class="card-stacked">
        <div class="card-content"style="font-size:15px;">
         
          <p>Nom:  <?php echo e(Session::get('number')->nom); ?> <br>
          <p>Prénom: <?php echo e(Session::get('number')->prenom); ?> <br>
          <p>Sexe: <?php echo e(Session::get('number')->sexe); ?> <br>
          <p>Tel: <?php echo e(Session::get('number')->tel); ?>  <br>
          <p>Licence: <?php echo e(Session::get('number')->licence); ?>  <br>
          <p>Date de validité: <?php echo e(Session::get('number')->date_valide); ?>  <br>
          <p>Nom du club: <?php echo e(Session::get('number')->club); ?>  <br>
          <p>Cartégorie sportive: <?php echo e(Session::get('number')->categorie); ?> <br>
          <p>Visite médicale: <?php echo e(Session::get('number')->medical); ?> <br>
          <p>Groupe sanguin: <?php echo e(Session::get('number')->sang); ?> <br>
          <p>Société d'assurances: <?php echo e(Session::get('number')->assurance); ?> <br>
          </div>
